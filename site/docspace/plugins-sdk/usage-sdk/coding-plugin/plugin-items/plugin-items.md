...
| Type                                            | Description                                                                                                                                                                                                        |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [ArticleButtonItem](articlebuttonitem.md) | Describes an item that will be embedded in the article sidebar as a custom plugin component above the DevTools section.                                                                                           |
