...
| cryptoSupport         | string                 | `"true"`                                                                                                    | Enables end-to-end encryption support for this provider. See [Encryption](./encryption/encryption.md).                                                                            |
| order                 | integer                | `2`                                                                                                         | Defines the provider's position in the **Connect to cloud** dialog. Lower values appear first.                                                                                    |
| editorFrameSize       | string                 | `"finite"`                                                                                                  | Controls the editor frame sizing behavior. Used by some providers like Seafile and Moodle.                                                                                        |
